...
$experience = [
    ...
    [
        ...
        'comment' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
                        sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.'
    ],
    [
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <?php for ($i = 0; $i < count($experience); $i++): ?>
              <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['date']?> 
                <?php if ($i == 0): ?> 
                    - <span class="w3-tag w3-teal w3-round">Current</span></h6>
                <?php endif; ?>
                <p><?php echo $experience[$i]['comment']?></p>
                <hr>
            <?php endfor; ?>    
        </div>

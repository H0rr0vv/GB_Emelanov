...
//2. Создайте в самом начале php-файл (до тега DOCTYPE) переменные: имя, профессия, город/страна, e-mail, телефон. Задайте начальные значения переменным.
//3. В блоке контактной информации вместо текста в строкахх имя, профессия, город/страна, e-mail, телефон вставьте значения из переменныъ, которые создавали выше.
$name = 'Богдан';
$profession = 'Инженер-проектировщик';
$town_country = 'Хабаровск/Россия';
$e_mail = 'faik2k@gmail.com';
$phone = '89141595196';
$skills = [
    [
        'name' => 'Фотошоп',
